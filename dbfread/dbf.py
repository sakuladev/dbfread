...
class DBF(object):
    ...
    def _iter_records(self, record_type=b' '):
        with open(self.filename, 'rb') as infile, \
            ...
            # Skip to first record, and advance by the amount of records provided in record_skip
            infile.seek(self.header.headerlen + (self.header.recordlen * self.record_skip), 0)
